...
<div class="modal fade" tabindex="-1" role="dialog" id="edit-service-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form action="/API/maintenance/editService" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="box-body">
                        <div class="form-group">
                            <input style="display:none;" type="text" class="form-control" id="inputServiceIDEdit" name="inputServiceIDEdit">
                            <label class="col-md-3 control-label">Service Name</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="inputServiceNameEdit" name="inputServiceNameEdit">
                            </div>
                        </div><br><br>
                        <div class="form-group">
                            <label class="col-md-3 control-label">Service Type</label>
                            <div class="col-sm-9">
								<select name="inputServiceTypeEdit" id="inputServiceTypeEdit" class="form-control">
                                    @foreach($serviceType as $dataDropdown)
			                           <option value="{{ $dataDropdown->servicetype_id }}">{{ $dataDropdown->servicetype_name }}</option>
                                    @endforeach
								</select>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">Service Description</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="inputServiceDescEdit" id="inputServiceDescEdit" placeholder="Enter Service Description...">
                            </div>
                        </div><br><br>
                        <div class="form-group">
                            <label class="col-md-3 control-label">Service Fee</label>
